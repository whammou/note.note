...
** DONE Rework todo-keywords :subOrgmode:_Layout:KEYWORD:
...
** DONE Rework Orgroam Capture Templates :_Template:ORGROAM:
...
** ABRT Test Orgmode Include :subOrgmode:subPandoc:subGithub:_Layout:
...
-----
** DONE Tasks Capturing Update :_Layout:
...
** DONE Create Note Backlogs :_Structure:
...
** TODO Clean up Backlogs :_Cleanup:
...
:END:
#+html:</details>
** WAIT Modular Notes Repos :subGit:_Structure:
...
** DONE Implement Note Sync :_Cleanup:FileSync:
...
** DONE Implement Note Category :_Structure:
...
-----
** DONE Implement Reminder Note :_Structure:
...
** TODO [#A] Clean Up Todo List :_Cleanup:
:PROPERTIES:
