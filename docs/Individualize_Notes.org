...
#+begin_quote org
[!TIP]
Project milestones vary depending on the type of project, but they all serve the same purpose: 1. To track progress at key stages. 2. Ensure everything stays on course
#+end_quote
